...
export function deleteNextTweet(
  ...
  const menuButtonSelector = "article [data-testid='caret']";
  ...
  setTimeout(
    () => {
      ...
      if (!deleteOption) {
        ...
        // if we have two retweet icons is because it's a retweet (the "you retweeted" on the post header and the actual retweet icon).
